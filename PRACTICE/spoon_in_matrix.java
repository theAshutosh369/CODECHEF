...
// Ashutosh spoon_in_matrixirajdar
...
public class spoon_in_matrix {
    ...
    static void AshutoshKaUniqueAnswer () {
        ...
        for (int i = 0; i < n; i++) {
            ...
            String ad = "";
            for (int j = 0; j < m; j++) {
               if( t.charAt(j)>=78 && t.charAt(j)<=83)
               {
                   ad+=(char)(t.charAt(j)+32);
               }
                else{
                    ad+=t.charAt(j);
               }
        ...
        for (int i = 0; i < arr.size(); i++) {
            if( arr.get(i).contains("spoon")) {
                System.out.println("There is a spoon!");
                f=1;
                break;
            }
        }
        if( f==0 ) System.out.println("There is indeed no spoon!");
    }
