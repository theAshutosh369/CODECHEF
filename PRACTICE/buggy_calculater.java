...
// Ashutosh buggy_calculaterirajdar
...
//        System.out.println( len );
        ...
        for (int i = 0; i < stra.length(); i++) {
            ...
            int tempa = Integer.parseInt( Character.toString( stra.charAt(i) ) );
            int tempb = Integer.parseInt( Character.toString( strb.charAt(i) ) );

            String add = Integer.toString((tempb+tempa)%10 );
