...
public class Truthdare {
    ...
    static void AshutoshKaUniqueAnswer () {
        int tr = s.nextInt();
        ArrayList<Integer> ramt = new ArrayList<>();
        for (int i = 0; i < tr; i++) {
            ramt.add( s.nextInt() );
        }
        int dr = s.nextInt();
        ArrayList<Integer> ramd = new ArrayList<>();
        for (int i = 0; i < dr; i++) {
            ramd.add( s.nextInt() );
        }
        ...
        int ts = s.nextInt();
        int[] shyamt = new int[ts];
        for (int i = 0; i < ts; i++) {
            shyamt[i] = s.nextInt();
        }
        int ds = s.nextInt();
        int[] shyamd = new int[ds];
        for (int i = 0; i < ds; i++) {
            shyamd[i] = s.nextInt();
        }
